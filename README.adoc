...
In order to see all issues & detectors in arquillian reports, you have to put arquillian-recorder-reporter dependency in your
Arquillian maven test.
...
You will get Redmine's all issues & detector information located in target/arquillian-report.xml.
