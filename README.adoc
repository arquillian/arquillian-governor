...
Imagine you have a customised workflow for closing issues, e.g 'New' -> 'Executing' -> 'close', in this case you will have to provide statuses id order so governor redmine can close your issues.
