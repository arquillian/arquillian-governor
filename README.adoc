...
image::https://github.com/rmpestano/arquillian-governor/tree/master/redmine/enable-api.png[]

And also will need an *apikey*. The apikey can be found in your user's account, see image bellow:

image::https://github.com/rmpestano/arquillian-governor/tree/master/redmine/get-your-api.png[]
...
Here is a closed issue by Governor Redmine:

image::https://github.com/rmpestano/arquillian-governor/tree/master/redmine/closed.png[]
